...
SET @조회일 = '2023-04-30'; # 실제로는 now() 같이 현 날짜로 변경하기.
SET @출발일 = '2023-05-01';
...
# 탑승객 1 김정민
SET @LAST_NAME = 'KIM';
SET @FIRST_NAME = 'JEONGMIN';
SET @GENDER = '남자';
SET @DAY_OF_BIRTH = '1999-03-01';
SET @AGE = YEAR(DATE_SUB(NOW(), INTERVAL @DAY_OF_BIRTH YEAR)) + 1;
SET @NATIONALITY = '대한민국(KOREA, REPUBLIC OF)';
SET @PHONE_NUMBER = '010-9415-3892';
SET @EMAIL = 'kjmsgcg@gmail.com';
...
SET @EMAIL_2 = 'prettySiYeon@gmail.com';
...
# 모든 금액을 결제완료 하면 티켓이 발급되고 결제수단에 결제 데이터들이 기록된다.
SET @항공권_ID = '1';
SET @티켓_ID = '1';
